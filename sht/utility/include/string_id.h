...
#define COMPILE_TIME_CRC32_STR(x) (sht::utility::crc32<sizeof(x) - 2>(x) ^ 0xFFFFFFFF)

// Same as the macro above, returns string ID
#define SID(x) (sht::utility::crc32<sizeof(x) - 2>(x) ^ 0xFFFFFFFF)
