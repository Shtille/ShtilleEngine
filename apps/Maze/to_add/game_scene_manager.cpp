...
static sht::graphics::Resource * ModelLoadingFunc(void * user_data, sht::utility::ResourceID id)
{
	...
	sht::graphics::ComplexMesh * mesh = new sht::graphics::ComplexMesh(renderer, nullptr);
...
, fullscreen_toggle_requested_(false)
{
	...
	game_scene_ = new GameScene(renderer, this, &game_settings_);
...
void GameSceneManager::RegisterAllResources()
{
	...
	if (file.OpenForRead("data/ini/apps/Maze/app.ini"))
	{
